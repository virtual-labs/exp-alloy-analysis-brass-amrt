...
<?php include('breadcum.php'); ?>
  ...
  <blockquote> 
    <span class="title">Alloy_analysis</span>
...
<p align="center">
  <iframe src="<?php echo 'vlab/'.$sub.'/'.$brch.'/'.$sim.'/'.'index.html'?>" frameborder="0" height="600" width="800" scrolling="no"></iframe></blockquote>&nbsp;
</div>
